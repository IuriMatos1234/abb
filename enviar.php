...
$email_envio = 'contato@abbiomedicina.com.br'; // E-mail receptor
$email_pass = ';Ie:=lM2hdkwg]yXkW'; // Senha do e-mail

$site_name = 'Associação Baiana de Biomedicina'; // Nome do Site
$site_url = 'http://www.abbiomedicina.com.br'; // URL do Site


$host_smtp = 'mx1.hostinger.com.br'; // HOST SMTP Ex: smtp.domain.com.br
